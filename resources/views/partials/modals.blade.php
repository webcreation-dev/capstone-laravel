<!-- Modal Update Date -->
                <div class="kt-modal" data-kt-modal="true" id="modal_update_date">
                    <div class="kt-modal-content max-w-[500px]">
                        <div class="kt-modal-header px-5 py-4 border-b">
                            <h3 class="kt-modal-title">Mettre à jour la date</h3>
                            <button class="kt-btn kt-btn-icon kt-btn-sm kt-btn-ghost" data-kt-modal-dismiss="true">
                                <i class="ki-filled ki-cross"></i>
                            </button>
                        </div>
                        <div class="kt-modal-body p-5">
                            <div class="flex flex-col gap-4">
                                <label class="kt-form-label">Nouveau Statut</label>
                                <select class="kt-select">
                                    <option value="revise">Révisé</option>
                                    <option value="reel" selected>Réel</option>
                                </select>

                                <label class="kt-form-label">Date effective</label>
                                <input type="date" class="kt-input" value="2026-06-16" />

                                <label class="kt-form-label">Commentaire</label>
                                <textarea class="kt-input" rows="3"
                                    placeholder="Raison de la révision ou détails..."></textarea>

                                <label class="kt-form-label">Fichier Justificatif</label>
                                <input type="file" class="kt-input" />
                            </div>
                        </div>
                        <div class="kt-modal-footer flex justify-end gap-2 px-5 py-4 border-t">
                            <button class="kt-btn kt-btn-outline" data-kt-modal-dismiss="true">Annuler</button>
                            <button class="kt-btn kt-btn-primary" data-kt-modal-dismiss="true">Enregistrer</button>
                        </div>
                    </div>
                </div>

                <!-- Modal Add Comment -->
                <div class="kt-modal" data-kt-modal="true" id="modal_add_comment">
                    <div class="kt-modal-content max-w-[600px]">
                        <div class="kt-modal-header px-5 py-4 border-b">
                            <h3 class="kt-modal-title">Commentaire & Fichiers</h3>
                            <button class="kt-btn kt-btn-icon kt-btn-sm kt-btn-ghost" data-kt-modal-dismiss="true">
                                <i class="ki-filled ki-cross"></i>
                            </button>
                        </div>
                        ...
                        <div class="kt-modal-body p-5">
                            ...
                            <div class="bg-gray-50 rounded p-3 mb-4 text-sm">
                                <div class="font-medium text-gray-700">SPM-TRVX-1 > T-01 > Lot 1 > Révisé 2</div>
                                <div class="text-gray-500 mt-1">Date de soumission : 03 Juillet 2027</div>
                            </div>

                            <!-- Commentaire -->
                            <div class="mb-4">
                                <label class="kt-form-label">Commentaire</label>
                                <textarea class="kt-input" rows="4"
                                    placeholder="Expliquez la raison de cette révision ou ajoutez des notes..."></textarea>
                            </div>

                            <!-- Fichiers joints -->
                            <div>
                                <label class="kt-form-label">Fichiers justificatifs</label>
                                <input type="file" class="kt-input" multiple />
                                <p class="text-xs text-muted-foreground mt-1">Formats acceptés : PDF, Word, Excel,
                                    Images (max 10MB par fichier)</p>
                            </div>
                        </div>
                ...
                <!-- Modal View Comment -->
                <div class="kt-modal" data-kt-modal="true" id="modal_view_comment">
                    <div class="kt-modal-content max-w-[700px]">
                        <div class="kt-modal-header px-5 py-4 border-b">
                            <h3 class="kt-modal-title">Commentaires & Fichiers attachés</h3>
                            <button class="kt-btn kt-btn-icon kt-btn-sm kt-btn-ghost" data-kt-modal-dismiss="true">
                                <i class="ki-filled ki-cross"></i>
                            </button>
                        </div>
                        ...
                        <div class="kt-modal-body p-5">
                            ...
                            <div class="bg-gray-50 rounded p-3 mb-4 text-sm">
                                <div class="font-medium text-gray-700">SPM-TRVX-1 > T-01 > Lot 1 > Révisé 2</div>
                                <div class="text-gray-500 mt-1">Date de soumission : 03 Juillet 2027 (RÉEL)</div>
                            </div>
                            ...
                            <div class="space-y-4 mb-4">
                                ...
                                <div class="border border-gray-200 rounded-lg p-4">
                                    <div class="flex items-start justify-between mb-2">
                                        <div class="flex items-center gap-2">
                                            ...
                                            <span class="font-medium text-sm">Jean Dupont</span>
                                        </div>
                                        <span class="text-xs text-muted-foreground">03 Juil 2027, 14:30</span>
                                    </div>
                                    <p class="text-sm text-gray-700 mb-3">
                                        Date de soumission effectuée avec succès. Le dossier a été déposé auprès de la
                                    ...
                                    <div class="space-y-2">
                                        <div class="flex items-center justify-between p-2 bg-gray-50 rounded">
                                            <div class="flex items-center gap-2">
                                                <i class="ki-filled ki-file text-primary"></i>
                                                <div>
                                                    <span
                                                        class="text-sm font-medium">justification_soumission.pdf</span>
                                                    <span class="text-xs text-gray-500 ml-2">(2.3 MB)</span>
                                                </div>
                                            </div>
                                            <button class="kt-btn kt-btn-xs kt-btn-icon kt-btn-ghost"
                                                title="Télécharger">
                                                <i class="ki-filled ki-download text-primary"></i>
                                            </button>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="border border-gray-200 rounded-lg p-4">
                                    <div class="flex items-start justify-between mb-2">
                                        <div class="flex items-center gap-2">
                                            <i class="ki-filled ki-user text-primary"></i>
                                            <span class="font-medium text-sm">Marie Martin</span>
                                        </div>
                                        <span class="text-xs text-muted-foreground">05 Juil 2027, 09:15</span>
                                    </div>
                                    <p class="text-sm text-gray-700">
                                        Confirmation de réception par la commission. Dossier enregistré sous le numéro
                                        2027-AO-045.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div class="border-t pt-4">
                                <label class="kt-form-label text-sm mb-2">Ajouter un commentaire</label>
                                <textarea class="kt-input" rows="3"
                                    placeholder="Ajouter une note supplémentaire..."></textarea>
                                <div class="mt-3">
                                    <label class="kt-form-label text-sm mb-2">Fichiers supplémentaires</label>
                                    <input type="file" class="kt-input" multiple />
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="kt-modal-footer flex justify-end gap-2 px-5 py-4 border-t">
                            ...
                            <button class="kt-btn kt-btn-primary">Ajouter le commentaire</button>
                        </div>
                    </div>
                </div>

                <!-- Modal Add SPM -->
                <div class="kt-modal" data-kt-modal="true" id="modal_add_spm">
                    <div class="kt-modal-content max-w-[600px]">
                        <div class="kt-modal-header px-5 py-4 border-b">
                            <h3 class="kt-modal-title">Ajouter un Système de Passation de Marché (SPM)</h3>
                            <button class="kt-btn kt-btn-icon kt-btn-sm kt-btn-ghost" data-kt-modal-dismiss="true">
                                <i class="ki-filled ki-cross"></i>
                            </button>
                        </div>
                        <div class="kt-modal-body p-7">
                            <div class="flex flex-col gap-7">
                                <div>
                                    <label class="kt-form-label mb-2">Type de Package</label>
                                    <select class="kt-select">
                                ...
                                <div>
                                    <label class="kt-form-label mb-2">Description du Package</label>
                                    <input type="text" class="kt-input" placeholder="Ex: Construction de route..." />
                                </div>
                                <div class="border-t pt-5">
                                    <h4 class="font-medium mb-4 text-base">Lots associés</h4>
                                    <div class="flex flex-col gap-3">
                                        <div class="flex items-center gap-3">
                                            <input type="text" class="kt-input w-1/4" placeholder="N° Lot"
                                                value="Lot 1" />
                                            <input type="text" class="kt-input w-3/4"
                                                placeholder="Description du Lot" />
                                        </div>
                                        <button class="kt-btn kt-btn-sm kt-btn-outline kt-btn-dashed w-full mt-2">
                                            <i class="ki-filled ki-plus"></i> Ajouter un lot
                                        </button>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="kt-modal-footer flex justify-end gap-2 px-5 py-4 border-t">
                            <button class="kt-btn kt-btn-outline" data-kt-modal-dismiss="true">Annuler</button>
                            <button class="kt-btn kt-btn-primary" data-kt-modal-dismiss="true">Créer le SPM</button>
                        </div>
                    </div>
                </div>
                ...
                <div class="kt-tabs kt-tabs-line justify-between px-5 mb-2.5" data-kt-tabs="true">
                    <div class="flex items-center gap-5">
                        ...
                        <button class="kt-tab-toggle py-5"
                            data-kt-tab-toggle="#search_modal_settings">Paramètres</button>
                ...
                <div class="kt-scrollable-y-auto" data-kt-scrollable="true" data-kt-scrollable-max-height="auto"
                    ...
                    <div class="" id="search_modal_mixed">
                        <div class="flex flex-col gap-2.5">
                            <div>
                                <div class="text-xs text-secondary-foreground font-medium pt-2.5 pb-1.5 ps-5">Paramètres
                                </div>
                                                ...
                                                <div class="flex items-center gap-2.5">
                                                    ...
                                                    <div class="flex flex-col">
                                                        <a class="text-sm font-semibold text-mono hover:text-primary mb-px"
                                                            href="#">Étude d'impact environnemental (Lot 1)</a>
                                        ...
                                        <div class="kt-menu-item">
                                            <div class="kt-menu-link flex justify-between gap-2">
                                                <div class="flex items-center gap-2.5">
                                                    ...
                                                    <div class="flex flex-col">
                                                        <a class="text-sm font-semibold text-mono hover:text-primary mb-px"
                                                            href="#">Sélection cabinet d'audit financier 2026</a>
                                                        <span class="text-2sm font-normal text-muted-foreground">
                                ...
                                <div class="kt-menu-item">
                                    <div class="kt-menu-link flex justify-between gap-2">
                                        <div class="flex items-center gap-2.5">
                                            ...
                                            <div class="flex flex-col">
                                                <a class="text-sm font-semibold text-mono hover:text-primary mb-px"
                                                    href="#">Assistance technique à la maîtrise d'ouvrage</a>
                                                <span class="text-2sm font-normal text-muted-foreground">
        ...
        <div class="kt-modal-content max-w-[500px] top-5 lg:top-[15%]">
            ...
            <div class="kt-modal-body grid gap-5 px-0 py-5">
                    ...
                    <div class="flex flex-col px-5 gap-3">
                        <div class="flex items-center flex-wrap gap-2">
                            <div class="flex items-center grow gap-2.5">
                                ...
                                <div class="flex flex-col">
                                    <a class="text-sm font-semibold text-mono hover:text-primary mb-px" href="#">Étude
                                        d'impact environnemental (Lot 1)</a>
                ...
                <div class="flex flex-col px-5 gap-4">
                    <label class="text-mono font-semibold text-sm">Paramètres</label>
...
<div class="hidden kt-drawer kt-drawer-end flex-col top-0 bottom-0 end-0 bg-background border-l border-border"
    ...
    <form id="spm_form" class="flex flex-col h-full w-full" onsubmit="event.preventDefault(); saveSpm();">
        ...
        <div class="flex items-center justify-between gap-2.5 text-xl font-medium leading-none text-mono px-5 py-5 border-b border-b-border"
            id="add_spm_header">
            <span id="spm_drawer_title">Nouvelle Ligne PPM</span>
            <button type="button" class="kt-btn kt-btn-sm kt-btn-icon kt-btn-dim shrink-0" data-kt-drawer-dismiss="true">
                <i class="ki-filled ki-cross"></i>
            </button>
        </div>
        
        <div class="kt-scrollable grow kt-scrollable-y p-5 lg:p-7.5 bg-secondary/30" id="spm_scrollable_container" data-kt-scrollable="true" data-kt-scrollable-dependencies="#add_spm_header, #add_spm_footer" data-kt-scrollable-offset="0px">
           <div class="flex grow gap-5 lg:gap-7.5">
           <div class="hidden lg:block w-[230px] shrink-0 sticky top-0 self-start pt-2">
            <div class="w-[230px]">
             <div class="flex flex-col grow relative before:absolute before:left-[11px] before:top-0 before:bottom-0 before:border-l before:border-border" data-kt-scrollspy="true" data-kt-scrollspy-offset="20px" data-kt-scrollspy-target="#spm_scrollable_container">
           ...
           <div class="flex flex-col items-stretch grow gap-5 lg:gap-7.5">
              ...
              <div class="kt-card-content grid gap-5">
               ...
               <div class="w-full">
                <div class="flex items-baseline flex-wrap lg:flex-nowrap gap-2.5">
                 ...
                 <textarea class="kt-input min-h-[100px] w-full py-3" name="package_description" id="spm_package_description" placeholder="Détails de la mission ou du package..."></textarea>
                </div>
               </div>
              </div>
             </div>
             ...
             <div class="kt-card pb-2.5">
              <div class="kt-card-header flex justify-between items-center" id="lots_associes">
               <h3 class="kt-card-title">Lots associés</h3>
               <button type="button" class="kt-btn kt-btn-sm kt-btn-light-primary" onclick="addLot()">
                 <i class="ki-filled ki-plus"></i> Ajouter un lot
               </button>
              </div>
              <div class="kt-card-content grid gap-5 pt-7.5" id="lots_container">
                 <!-- Les lots seront injectés ici par JS -->
              </div>
              <div class="kt-card-footer border-t border-t-border pt-4 mt-2">
                 <button type="button" class="kt-btn kt-btn-sm kt-btn-light-primary" onclick="addLot()">
                   <i class="ki-filled ki-plus"></i> Ajouter un lot supplémentaire
                 </button>
              </div>
             </div>
            </div>
        ...
        <!-- Footer -->
        <div class="flex items-center justify-end gap-2.5 px-5 py-4 border-t border-t-border mt-auto" id="add_spm_footer">
            <button type="button" class="kt-btn kt-btn-light" data-kt-drawer-dismiss="true">Annuler</button>
            <button type="submit" class="kt-btn kt-btn-primary" id="btn_save_spm">Enregistrer le tout</button>
        </div>
    </form>
</div>
...
<template id="lot_template">
    <div class="lot-item border border-gray-200 rounded-lg p-5 mb-4 bg-gray-50/50">
        <input type="hidden" class="lot-id" name="lots[__INDEX__][id]">
        
        <!-- Header du lot avec le bouton de suppression -->
        <div class="flex items-center justify-end mb-4">
            <button type="button" class="kt-btn kt-btn-sm kt-btn-icon kt-btn-light-danger btn-remove-lot" title="Supprimer ce lot">
        ...
        <div class="grid gap-5">
            <div class="w-full">
                <div class="flex flex-col gap-1">
                    <label class="kt-form-label">Nom du lot</label>
                    <input class="kt-input lot-name" name="lots[__INDEX__][name]" type="text" placeholder="Ex: Lot 1 - Étude d'impact..." required />
                </div>
            </div>
            <div class="w-full">
                <div class="flex flex-col gap-1">
                    <label class="kt-form-label">Description du Lot</label>
                    <textarea class="kt-input min-h-[80px] w-full py-3 lot-description" name="lots[__INDEX__][description]" placeholder="Détails du lot..."></textarea>
                </div>
            </div>
        </div>
    </div>
