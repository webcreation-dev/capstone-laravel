                ...
                <div class="kt-container-fluid flex justify-between items-stretch lg:gap-4" id="headerContainer">
                    ...
                    <div class="flex items-center gap-2.5">
                                                ...
                                                <div class="flex flex-col gap-1">
                                                    <div class="text-sm font-medium mb-px">
                                                        <a class="hover:text-primary text-mono font-semibold"
                                                            href="#">Étude de faisabilité projet hydroélectrique</a>
                                                        <span class="text-secondary-foreground">
                                                            requested access to
                                                        </span>
                                                        <a class="hover:text-primary text-primary" href="#">
                        ...
                        <div class="hidden kt-drawer kt-drawer-end card flex-col max-w-[90%] w-[450px] top-5 bottom-5 end-5 rounded-xl border border-border"
                            ...
                            <div class="kt-tabs kt-tabs-line justify-between px-5 mb-2" data-kt-tabs="true"
                                id="date_details_tabs">
                                <div class="flex items-center gap-5">
                                    <button class="kt-tab-toggle py-3 active"
                                        data-kt-tab-toggle="#date_details_tab_comments">
                                        Commentaires
                                    </button>
                                    <button class="kt-tab-toggle py-3" data-kt-tab-toggle="#date_details_tab_documents">
                                        Documents
                                    </button>
                                </div>
                                <div class="kt-menu" data-kt-menu="true">
                            ...
                            <!-- Tab Commentaires -->
                            <div class="grow flex flex-col" id="date_details_tab_comments">
                                <div class="grow kt-scrollable-y-auto" data-kt-scrollable="true"
                                    data-kt-scrollable-dependencies="#header" data-kt-scrollable-max-height="auto"
                                    data-kt-scrollable-offset="150px">
                                    <div class="grow flex flex-col gap-5 pt-3 pb-4 divider-y divider-border">
                                ...
                                <div class="border-b border-b-border"></div>
                                <div class="grid grid-cols-2 p-5 gap-2.5" id="date_details_comments_footer">
                                    <button class="kt-btn kt-btn-outline justify-center">
                                        Tout supprimer
                                    </button>
                                    <button class="kt-btn kt-btn-outline justify-center">
                            ...
                            <!-- Tab Documents -->
                            <div class="grow flex flex-col hidden" id="date_details_tab_documents">
                                <div class="grow kt-scrollable-y-auto" data-kt-scrollable="true"
                                    data-kt-scrollable-dependencies="#header" data-kt-scrollable-max-height="auto"
                                    data-kt-scrollable-offset="150px">
                                    <div class="flex flex-col gap-5 pt-3 pb-4">
                                        ...
                                        <div class="px-5">
                                            <div
                                                class="kt-card shadow-none p-4 rounded-lg bg-muted/70 border-2 border-dashed border-border">
                                                <div class="flex flex-col items-center gap-2 text-center">
                                                    <i class="ki-filled ki-file-up text-3xl text-primary"></i>
                                                    <div class="text-sm font-semibold">Glisser-déposer ou cliquer pour
                                                        uploader</div>
                                                    <div class="text-xs text-muted-foreground">PDF, Word, Excel, Images
                                                        (max 10MB)</div>
                                                    <input type="file" class="hidden" id="file_upload_input" multiple />
                                                    <button class="kt-btn kt-btn-outline kt-btn-sm mt-2"
                                                        onclick="document.getElementById('file_upload_input').click()">
                                                        Parcourir
                                                    </button>
                                                </div>
                                            </div>
                                ...
                                <div class="border-b border-b-border"></div>
                                <div class="grid grid-cols-2 p-5 gap-2.5" id="date_details_documents_footer">
                                    <button class="kt-btn kt-btn-outline justify-center">
                                        Télécharger tout
                                    </button>
                                    <button class="kt-btn kt-btn-outline justify-center">
                                                    ...
                                                    <div class="kt-menu-dropdown kt-menu-default w-full max-w-[175px]"
                                                        ...
                                                        <div class="kt-menu-item">
                                                            <a class="kt-menu-link"
                                                                ...
                                                                <span class="kt-menu-title">Paramètres</span>
                                                            </a>
                                                        </div>
                                                    </div>
                                                </div>
                                ...
                                <div class="flex items-center justify-between px-2.5 py-1.5 gap-1.5">
                                    <div class="flex items-center gap-2">
                                        <img alt="" class="size-9 shrink-0 rounded-full border-2 border-green-500"
                                            src="{{ asset('assets/media/avatars/300-2.png') }}" />
                                        <div class="flex flex-col gap-1.5">
                                            <span class="text-sm text-foreground font-semibold leading-none">Assistance
                                                technique à la maîtrise d'ouvrage</span>
                                            <a class="text-xs text-secondary-foreground hover:text-primary font-medium leading-none"
                                                href="html/demo1/account/home/get-started.html">PKG-2026-003</a>
                                        </div>
                                    </div>
